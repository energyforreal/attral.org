    ...
    <div class="container">
      ...
      <div class="card-grid-4">
        <article class="card card--project">
          <img class="card__image" src="https://via.placeholder.com/600x360?text=Project+1" alt="Project 1" loading="lazy">
        ...
        <article class="card card--project">
          <img class="card__image" src="https://via.placeholder.com/600x360?text=Project+2" alt="Project 2" loading="lazy">
          <div class="card__body">
        ...
        <article class="card card--project">
          <img class="card__image" src="https://via.placeholder.com/600x360?text=Project+3" alt="Project 3" loading="lazy">
          <div class="card__body">
